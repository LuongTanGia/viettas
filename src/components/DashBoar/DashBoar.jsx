          ...
          <div className="col-lg-3">
            <div className="card">
              ...
              <div className="card-body pb-0">
                ...
                <div className="activity" style={{ minHeight: '200px' }}>
                  <RateBar percentage={85} color={'linear-gradient( 135deg, #81FFEF 10%, #F067B4 100%)'} />
                  <RateBar percentage={75} color={'linear-gradient( 135deg, #C2FFD8 10%, #465EFB 100%)'} />
                  <RateBar percentage={85} color={'linear-gradient( 135deg, #90F7EC 10%, #32CCBC 100%)'} />
                  <RateBar percentage={65} color={'linear-gradient( 135deg, #F97794 10%, #623AA2 100%)'} />
                  <RateBar percentage={85} color={' linear-gradient( 135deg, #FAD7A1 10%, #E96D71 100%)'} />
                </div>
              </div>
            </div>
          </div>
