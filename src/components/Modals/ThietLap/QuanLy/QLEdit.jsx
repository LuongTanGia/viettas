...
import { Checkbox, Select, Tooltip, Input } from 'antd'
import { DateField } from '@mui/x-date-pickers'
import { RETOKEN, base64ToPDF } from '../../../../action/Actions'
import SimpleBackdrop from '../../../util/Loading/LoadingPage'
const QLEdit = ({ close, loadingData, setTargetRow, dataQL, maNguoiDung }) => {
  ...
  const [QLForm, setQLForm] = useState(() => {
    return dataQL ? { ...dataQL } : innitProduct
  })
                  ...
                  <div className="grid grid-cols-1 mt-1 gap-2 px-2 py-2.5 rounded border-black-200 ml-[95px] relative border-[0.125rem]">
                    ...
                    <div className="flex gap-1">
                      ...
                      <div className="flex items-center gap-1 whitespace-nowrap">
                        ...
                        <Tooltip title={moment(dataQL?.NgayTao)?.format('DD/MM/YYYY HH:mm:ss')} color="blue">
                          <input
