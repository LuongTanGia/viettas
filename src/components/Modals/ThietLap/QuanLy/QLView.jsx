                ...
                <div className="flex flex-col gap-2 border-1 border-gray-400 px-2 py-2.5">
                  <div className="flex items-center gap-2">
                    <div className="flex items-center gap-1 w-[60%]">
                      ...
                      <input type="text" value={dataQLView?.MaQuanLy || ''} className="px-2 h-6 w-full resize-none rounded-[3px] border outline-none text-sm truncate" disabled />
                    </div>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <input type="text" value={dataQLView?.TenNguoiDung || ''} className="px-2 h-6 w-full resize-none rounded-[3px] border outline-none text-sm truncate" disabled />
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="flex items-center gap-1">
                    ...
                    <div className="flex items-center">
                      <Checkbox className="text-sm whitespace-nowrap" checked={dataQLView?.KhongKetThuc}>
                        Không kết thúc
                      </Checkbox>
                    </div>
                  </div>
                  <div className="flex items-center gap-1">
                    ...
                    <input type="text" value={dataQLView?.GhiChu || ''} className="px-2 h-6 w-full resize-none rounded-[3px] border outline-none text-sm truncate" disabled />
                  </div>
