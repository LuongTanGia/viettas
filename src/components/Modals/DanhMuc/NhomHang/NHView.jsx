                    ...
                    <div className="flex gap-2">
                      <div className="flex items-center gap-2 whitespace-nowrap">
                        ...
                        <Tooltip title={dataNHView?.NguoiTao} color="blue">
                          <input value={dataNHView?.NguoiTao || ''} className="w-full px-2 rounded-[3px] resize-none border outline-none text-sm truncate" disabled />
                        </Tooltip>
                      </div>
                      <div className="flex items-center gap-2 whitespace-nowrap ">
                    ...
                    <div className="flex gap-2">
                      <div className="flex items-center gap-2 whitespace-nowrap">
                        ...
                        <Tooltip title={dataNHView?.NguoiSuaCuoi} color="blue">
                          <input value={dataNHView?.NguoiSuaCuoi || ''} className="w-full px-2 rounded-[3px]  resize-none border outline-none text-sm truncate" disabled />
                        </Tooltip>
                      </div>
                      <div className="flex items-center gap-2 whitespace-nowrap ">
                        <label className=" text-sm">Lúc</label>
