                ...
                <div className="flex gap-2">
                  <div className="flex items-center gap-2 whitespace-nowrap">
                    ...
                    <Tooltip title={dataNH?.NguoiTao} color="blue">
                      <input value={dataNH?.NguoiTao || ''} className="w-full px-2 rounded-[3px] resize-none border outline-none text-sm truncate" disabled />
                    </Tooltip>
                  </div>
                  <div className="flex items-center gap-2 whitespace-nowrap">
                ...
                <div className="flex gap-2">
                  <div className="flex items-center gap-2 whitespace-nowrap">
                    ...
                    <Tooltip title={dataNH?.NguoiSuaCuoi} color="blue">
                      <input value={dataNH?.NguoiSuaCuoi || ''} className="w-full px-2 rounded-[3px] resize-none border outline-none text-sm truncate" disabled />
                    </Tooltip>
                  </div>
                  <div className="flex items-center gap-2 whitespace-nowrap">
                    <label className=" text-sm">Lúc</label>
