              ...
              <div className="flex flex-col gap-2 py-1 px-2 xl:w-[80vw] lg:w-[90vw] md:w-[95vw] ">
                ...
                <div className="flex flex-col gap-2 border-2 px-1 py-2.5">
                    ...
                    <div className="flex flex-col gap-3">
                      <div className="flex gap-2">
                        <div className="flex items-center gap-1">
                          ...
                          <input type="text" value={dataNDCView?.SoChungTu || ''} className="px-2 w-full resize-none rounded border outline-none text-sm truncate" disabled />
                        </div>
                        <div className="flex items-center gap-1">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <input type="text" value={dataNDCView?.GhiChu || ''} className="px-2 w-[70rem] rounded resize-none border outline-none text-sm" disabled />
                  </div>
