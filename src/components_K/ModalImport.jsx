...
const ModalImport = ({ close, namePage }) => {
  return (
    <div className=" w-[90vw] h-[600px] ">
          ...
          <div className="w-full">
            <div className="flex flex-col pt-3  ">
              <div className="flex items-center p-1 gap-2">
                ...
                <input type="text" className="h-[24px] px-2 rounded-[4px] w-full resize-none border-[1px] border-gray-300 outline-none " />
                <ActionButton
                  color={'slate-50'}
                  title={'Nạp dữ liệu'}
                  background={'bg-main'}
      ...
      <div className=" flex justify-between items-center">
        ...
        <div className="flex  items-center gap-3  pt-3">
          <ActionButton color={'slate-50'} title={'Lưu'} background={'bg-main'} bg_hover={'white'} color_hover={'bg-main'} />
          <ActionButton color={'slate-50'} title={'Lưu & đóng'} background={'bg-main'} bg_hover={'white'} color_hover={'bg-main'} />
