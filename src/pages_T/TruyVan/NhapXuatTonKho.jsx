        ...
        <div className="flex flex-col py-2 px-4 gap-4">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-between relative">
              ...
              <div form={form} className="DayShow -mb-4">
                <Form.Item
                  name="dateRange"
                  label={
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div
                    className="flex items-center gap-2 px-2 py-1 bg-blue-600 text-white rounded-lg cursor-pointer shadow-custom hover:bg-white hover:text-blue-600"
