        ...
        return (
          <>
            <div className="flex gap-2 items-center justify-center">
              <div
                className="p-2 bg-yellow-400 rounded-md text-white cursor-pointer shadow-custom hover:bg-white hover:text-yellow-400"
                title="Sửa"
              ...
              <div
                className="p-2 bg-red-500 rounded-md text-white cursor-pointer  shadow-custom hover:bg-white hover:text-red-500 "
                title="Xóa"
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex justify-between relative">
                ...
                <div>
                  ...
                  {isShowOption && (
                    <div className="flex flex-col gap-4 bg-slate-100 p-4 absolute top-0 right-[2.5%] rounded-lg z-10 duration-500 shadow-custom ">
                      <div
                        className="px-3 py-2 bg-blue-600 rounded-lg font-semibold text-white shadow-custom flex gap-1 items-center cursor-pointer hover:bg-white hover:text-blue-600"
                      ...
                      <div
                        className="justify-center px-3 py-2 bg-green-600 rounded-lg font-semibold text-white shadow-custom flex gap-1 items-center cursor-pointer hover:bg-white hover:text-green-600"
                      ...
                      <div
                        className="justify-center px-3 py-2 bg-orange-600 rounded-lg font-semibold text-white shadow-custom flex gap-2 items-center cursor-pointer hover:bg-white hover:text-orange-600"
                        onClick={() => handleGroup()}
                      >
                      ...
                      <div
                        className="justify-center px-3 py-2 bg-purple-600 rounded-lg font-semibold text-white shadow-custom flex gap-1 items-center cursor-pointer hover:bg-white hover:text-purple-600"
