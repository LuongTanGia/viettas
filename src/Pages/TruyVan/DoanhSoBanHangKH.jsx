...
const DoanhSoBanHangKH = () => {
  ...
  const [NhomDoiTuong, setNhomDoiTuong] = useState([])
  ...
  useEffect(() => {
    const ListNhomDoiTuong = async () => {
      try {
        ...
        if (response.data.DataError == 0) {
          setNhomDoiTuong(response.data.DataResults)
          setIsLoading(true)
        } else {
          setNhomDoiTuong([])
          setIsLoading(true)
  ...
  useEffect(() => {
    const getDataDSBHFirst = async () => {
      try {
        if (isLoading == true) {
          setTableLoad(true)
          const response = await categoryAPI.InfoDSBHKhachHang(
            dateData == {}
              ? {}
              : {
                ...
                <div className="flex justify-between">
                  <div className="flex gap-2 items-center ">
                    <div className="flex items-center gap-2 py-1">
                      <h1 className="text-lg font-bold text-black-600 uppercase">Doanh số bán hàng (Khách hàng)</h1>
                    ...
                    <div className="flex gap-1">
                      <div className="flex gap-1 items-center">
                        ...
                        <Select
                          ...
                          onChange={(value) => {
                            ...
                            if (selectedNhomTo !== null && NhomDoiTuong.findIndex((item) => item.Ma === value) > NhomDoiTuong.findIndex((item) => item.Ma === selectedNhomTo)) {
                      ...
                      <div className="flex gap-1 items-center">
                        ...
                        <Select
                          ...
                          onChange={(value) => {
                            setSelectedNhomTo(value)
                            if (selectedNhomFrom !== null && NhomDoiTuong.findIndex((item) => item.Ma === value) < NhomDoiTuong.findIndex((item) => item.Ma === selectedNhomFrom)) {
                              setSelectedNhomFrom(value)
                            }
...
export default DoanhSoBanHangKH
